...
public class Server {
    ...
    Server() {
        ...
        System.out.println("Te dhenat ne Server");
        ...
        try {
            ...
            while(true) {
                ...
                String enter_message = "{ \"name\" : \"" + "[ SERVER NOTICE ]" + "\", \"message\" : \"" + name +" u konektua" + "\"}";
                ...
                System.out.println("[Online Users : " + Server.clients.size() + "]");
